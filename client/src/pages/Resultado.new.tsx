...
export default function Resultado() {
  ...
  useEffect(() => {
    if (estado && companhiasEletricas[estado]) {
      setCompanhiasDisponiveis(companhiasEletricas[estado]);
      
      // Se a companhia atual não está na lista do estado selecionado, usar a primeira
      if (!companhiasEletricas[estado].includes(companhia)) {
        setCompanhia(companhiasEletricas[estado][0]);
        companhiaForm.setValue("companhia", companhiasEletricas[estado][0]);
      }
    } else {
