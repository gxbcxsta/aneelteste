          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-l-4 border-[var(--gov-yellow)]">
              <CardContent className="p-6">
                ...
                <p className="text-[var(--gov-gray-dark)]">
                  Para solicitar a restituição, você precisará apenas do seu CPF e confirmar alguns dados pessoais básicos para validação da sua identidade no sistema GOV.BR.
                </p>
              </CardContent>
            </Card>
          </div>
