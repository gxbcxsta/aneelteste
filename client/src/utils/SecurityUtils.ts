 ...
 * SecurityUtils.ts
 * 
 * Utilitários de segurança para proteção da aplicação
 */
...
/**
 * Detecta tentativas de inspeção e ferramentas de desenvolvedor
 */
...
export function initializeSecurity(): void {
  ...
  */
  ...
  // Comentado para facilitar desenvolvimento
